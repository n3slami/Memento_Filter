...
#define QF_KEY_IS_HASH (0x08)
	...
	*******************************************/
	 ...
	 * contents of the buffers. Use this function if you have read a CQF,
     * e.g. off of disk or network, and want to begin using that stream of
	 ...
	 * into it. If there is not enough space at buffer then it will return the 
	 * total size needed in bytes to initialize the new CQF.
	 * */
	...
	************************************/
	...
	/* Initialize the CQF and allocate memory for it. */
